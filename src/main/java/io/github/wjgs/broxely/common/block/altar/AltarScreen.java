...
public class AltarScreen extends ContainerScreen<AltarContainer> {
    ...
    private ResourceLocation GUI = new ResourceLocation(Broxely.MODID, "textures/gui/altar_gui.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.font.drawString("Lava Infusion", 8.0F, 6.0F, 4210752);
        this.font.drawString("Altar", 8.0F, 16.0F, 4210752);
